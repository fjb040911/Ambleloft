...
test('history pages use stable turn cursors, preserve tool association, and omit bodies from index',()=>{
 const run={id:'r',messages:Array.from({length:100},(_,i)=>[{id:'u'+i,role:'user',text:'question'},{id:'a'+i,role:'assistant',text:'answer'}]).flat(),tools:[{id:'t',turnKey:'u10',detail:'large output'}],plans:[],artifacts:[],approvals:[]};
